        ...
        <div className="mb-20">
          ...
          <div className="fade-in-up stagger-2">
            <p className="text-xl font-light text-gray-600 max-w-2xl mx-auto">
              Founded by active composers who understand the intricacies of contemporary music notation
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-5 fade-in-right stagger-2">
            <div className="relative">
              ...
              <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-50 border border-black/10 relative overflow-hidden">
                ...
                <img
                  src="src/assets/imgs/example_1.jpg" 
        ...
        <div className="my-24">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center mb-16">
            <div className="lg:col-span-4 fade-in-left stagger-3">
              ...
              <p className="text-sm text-gray-500 uppercase tracking-wider mb-4">Founder & Lead Developer</p>
