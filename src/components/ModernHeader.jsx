    ...
    <>
      ...
      <header className="relative bg-white min-h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
        ...
        <div className="fade-in-up relative z-20">
          <h1 className="text-[6.2rem] sm:text-[8rem] md:text-[12rem] lg:text-[16rem] xl:text-[20rem] font-black leading-none mb-0 glitch" style={{ fontFamily: '"IBM Plex Sans", sans-serif' }}>
            ZSCORE
          </h1>
        </div>
