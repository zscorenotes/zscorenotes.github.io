...
export default function ModernServices() {
  ...
  const loadServices = async () => {
    try {
      let serviceData = await getServices();
      serviceData.sort((a, b) => new Date(b.created_date) - new Date(a.created_date));
              ...
              >
                <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20 grid md:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="md:col-span-5">
                    <h3 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight group-hover:text-gray-700 transition-colors duration-300">
                      {service.title}
                    </h3>
                  ...
                  <div className="md:col-span-6">
                    ...
                    <div className="mt-4 text-sm text-gray-500 group-hover:text-gray-600 transition-colors duration-300">
                      Click to learn more →
                    </div>
                  </div>
                </div>
